  ...
  const groups = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/dashboard/cadastru", testid: "link-cadastru", title: "Cadastru / carte funciară", desc: "Cerere de înscriere în CF + extras (ANCPI)." },
        { href: "/dashboard/urbanism", testid: "link-urbanism", title: "Urbanism / construcții", desc: "Certificat de urbanism + autorizație de construire." },
